...
export const PostFileUploader = ({ fieldChange, mediaUrl }: FileUploaderProps) => (
      ...
      <div className="file-uploader">
        {fileUrl ? (
          ...
          <div className="file-uploader__container">
            ...
            <p className="file-uploader__description">사진 형식 (PNG,SVG) 만 가능합니다</p>
